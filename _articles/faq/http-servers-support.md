...
To upload documents via HTTP, we recommend the API [here](/_articles/docs/general-usage/image-export/index.md#upload){:target="_blank"}.
...
For more information and sample server-side scripts, please refer to [Server Scripts](/_articles/docs/general-usage/server-side-scripting.md){:target="_blank"}, which includes sample scripts on how to save the uploaded file to a database such as MS SQL/Oracle, and how to resend the uploaded file by email.
