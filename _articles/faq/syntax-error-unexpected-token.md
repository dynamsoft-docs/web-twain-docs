...
Please refer to this link for more details on server deployment <a href="/web-twain/docs/general-usage/server-deployment.html" target="_blank">Dynamic Web TWAIN Deployment - Server Deployment</a>.
