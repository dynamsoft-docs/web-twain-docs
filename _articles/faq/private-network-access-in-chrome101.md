...
1. <a href="/web-twain/docs/indepth/development/upgrade.html" target="_blank">Upgrade</a> Dynamic Web TWAIN SDK to **version 17.2.1** or later
   ...
   Please note that once upgraded, the Dynamic Web TWAIN Service on all client machines also need to be updated. You may consider <a href="/web-twain/docs/faq/can-i-install-dynamsoft-service-silently.html#can-i-install-dynamsoft-service-silently" target="_blank">installing Dynamic Web TWAIN Service silently</a>.
