...
date: 2024-09-03 17:31:36 +0000
last_modified: 2024-09-20 15:00:08 +0000
---
...
- jsDelivr
  ...
  ```html
    <!--Dynamic Web TWAIN-->
    <script src="https://cdn.jsdelivr.net/npm/dwt@19.4.0/dist/dynamsoft.webtwain.min.js"></script>
...
- UNPKG
  ...
  ```html
    <!--Dynamic Web TWAIN-->
    <script src="https://unpkg.com/dwt@19.4.0/dist/dynamsoft.webtwain.min.js"></script>
    <!--Dynamsoft Document Viewer-->
...
2. Use a different CDN with a higher per-file size limit by referencing the location with `Dynamsoft.DWT.ServiceInstallerLocation = "https://unpkg.com/dwt@19.4.0/dist/dist"`.
...
Dynamsoft.DWT.ResourcesPath = "https://cdn.jsdelivr.net/npm/dwt@19.4.0/dist";
