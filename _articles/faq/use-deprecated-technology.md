...
Please check this page for more information on [Dynamic Web TWAIN & ActiveX: Dynamic Web TWAIN Development - About ActiveX ](/_articles/docs/indepth/development/activex.md){:target="_blank"}.
