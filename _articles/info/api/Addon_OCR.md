...
| `boolean` **`isOCRNumericOnly()`**                                                   | Return whether the OCR engine only OCR's numbers.                                                                                          |
| `void` **`setOCRIsNumericOnly(boolean bNumericOnly)`**                              | Set whether the OCR engine should only OCR numbers.                                                                                        |
